...
async def help(bot, message, cb=False):
    ...
    button = [[
        ...
        InlineKeyboardButton(f'📦 BOTS CHANNEL', url='https://t.me/KOT_BOTS'),
...
async def start(bot, message, cb=False):
    ...
    button = [[
        ...
        InlineKeyboardButton(f'📦 SUPPORT', url='https://t.me/KOT_REPORS'),
        InlineKeyboardButton(f'CLOSE 🔐', callback_data="close")
        ]]
    reply_markup = InlineKeyboardMarkup(button)
    if cb:
...
async def about(bot, message, cb=False):
    ...
    button = [[
        ...
        InlineKeyboardButton(f'📦 SOURCE', url='https://t.me/KOT_FREE_DE_LA_HOYA_OFF'),
        InlineKeyboardButton(f'CLOSE 🔐', callback_data="close")
        ]]
    reply_markup = InlineKeyboardMarkup(button)
    if cb:
    ...
    if Config.UPDATES_CHANNEL:
        ...
        try:
            ...
            if user.status == "kicked":
                await message.message.edit(
                    text="Sorry Sir, You are Banned. Contact My [Support Group](https://t.me/KOT_REPORS).",
                    parse_mode="markdown",
                    disable_web_page_preview=True
                )
                return
